...
Nie trzeba nic instalować ani budować — Vue, Tailwind i GSAP ładują się z CDN. Wystarczy otworzyć `index.html` lub w przeglądarce wpisać `https://taskly.hoe-sting.com/`[Taskly.com](https://taskly.hoe-sting.com/). Jeśli chcesz uniknąć ewentualnych problemów z Local Storage przy otwieraniu pliku bezpośrednio, możesz odpalić dowolny lokalny serwer, np.:
